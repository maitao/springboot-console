...
public class ZxingUtil {
	...
	public static void encode(String content, String imgPath, OutputStream output, boolean needCompress)
			throws Exception {
		BufferedImage image = ZxingUtil.createImage(content, imgPath, needCompress);
	...
	public static void main(String[] args) throws Exception {
		...
		String text = "<OrderResult startdate=\"20050401\" enddate=\"20050401\">" + "<Msg>0</Msg>"
				...
				+ "<signature> 96B406C29AD80CB0D4D71AF242C43AA9</signature>" + "</OrderResult> ";
		String destFileFullPath = ZxingUtil.encode(text, "E:/img/icon.png", "E:/img/", true);
