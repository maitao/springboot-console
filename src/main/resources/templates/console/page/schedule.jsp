...
<!-- fullCalendar 2.2.5-->
<link rel="stylesheet"
	href="mtcommon/lte/plugins/fullcalendar/fullcalendar.min.css">
<link rel="stylesheet"
	href="mtcommon/lte/plugins/fullcalendar/fullcalendar.print.css" media="print">
...
<!-- /.content -->
<!-- jQuery UI 1.11.4 --><!-- 会造成ztree的节点title错位 -->
<script src="mtcommon/js/jquery-ui.min.js"></script>

<!-- Page specific script -->
<script src="mtadmin/js/schedule.js"></script>
