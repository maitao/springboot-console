			...
			<div class="box box-primary">
				...
				<div class="box-footer clearfix">
					<div class="row">
						<div class="col-sm-4">
							<!-- <label
								style="font-weight: normal; text-align: left; white-space: nowrap;">每页
								记录 共7355条/736页 </label> -->
						</div>
						<div class="col-sm-8">
...
<script src="mtadmin/js/log.js"></script>
<script src="mtadmin/js/page.js"></script>
<script>
	commonPage.f_tableList(log, 'log', $("#tsList"), 1, pageCount, '');
</script>